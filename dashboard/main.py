...
st.markdown('''
    ...
    This analysis is based on the publicly available data from the [Swiss Federal Office of Energy (SFOE)](https://www.bfe.admin.ch/bfe/en/home/supply/statistics-and-geodata/energy-statistics/electricity-statistics.html).
''')
